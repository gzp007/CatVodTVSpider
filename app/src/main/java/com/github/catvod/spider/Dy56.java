 ...
 * Author: CatVod
 */
public class Dy56 extends Spider {
     ...
     *      <li><a href="/movie/list">电影</a></li>
     *      <li><a href="/ju/list">连续剧</a></li>
     *      <li><a href="/zy/list">综艺</a></li>
     *      <li><a href="/dm/list">动漫</a></li>
     *  </ul>
    ...
    public String homeContent(boolean filter) {
        try {
            ...
            // 分类节点
            Elements elements = doc.select("ul.type-slide.clearfix > li a");
            JSONArray classes = new JSONArray();
            for (Element ele : elements) {
                String name = ele.select("a").text();
                boolean show = name.equals("首页") ||
                        name.equals("电影") ||
                        name.equals("连续剧") ||
                        name.equals("综艺") ||
                        name.equals("动漫");
